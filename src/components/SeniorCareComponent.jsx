        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            <h1 className="text-4xl lg:text-5xl font-light text-gray-800 mb-6 leading-tight">
              A Special Community Designed to Meet the Unique Needs of Elders in Bangladesh, <span className="text-green-400 italic">With High-Quality Amenities.</span>
            </h1>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-sm text-gray-600 leading-relaxed mb-4">
                    At Life Log Care, we believe that elder care is not just about medicine, it’s about meaning. We’ve created a dedicated environment where seniors receive personalized support, emotional warmth, and high-quality amenities that honor their life journey.
                  </p>
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-xs text-gray-500">
                      Anwar Sadat Kabir, Founder & CEO of Life Cercle Bangladesh
                    </p>
                  </div>
                </div>
                ...
                <div>
                  <p className="text-sm text-gray-600 leading-relaxed mb-4">
                   Our community is built to reflect the values of Bangladeshi families: respect, compassion, and togetherness. From daily care routines to end-of-life dignity, every service is designed to offer peace of mind to families and fulfillment to our elders.
                  </p>
                  ...
                  <div className="mb-4">
                    <p className="text-xs text-gray-500 uppercase tracking-wider">Life Cercle Bangladesh</p>
          ...
          <div>
            <div className="mb-8">
              ...
              //  src='https://assets.elder.org/app/uploads/2022/05/25100216/nursing-care-costs-scaled-1-1024x682.jpg'
               src='https://daynightnursinghomecare.com/wp-content/uploads/2021/12/home-nursing-service-care-in-karachi.jpg'
            ...
            <div className="bg-green-400 text-white p-6 rounded-lg">
              ...
              <p className="text-sm opacity-90">The Best Part of Life” Begins Here</p>
              <p className="text-sm opacity-90">
                •	Individualized care plans tailored to each elder’s health, lifestyle, and emotional needs <br />
•	Trained caregivers who build genuine relationships and provide round-the-clock support <br />
•	Safe, accessible living spaces with medical-grade equipment and comfort-enhancing features <br />
•	Nutrition plans based on local tastes and health conditions <br />
•	Mental health and spiritual support through counseling, prayer, and community engagement <br />
•	End-of-life care that respects religious traditions and family wishes <br />
•	Funeral support services with full dignity and cultural sensitivity <br />
•	Opportunities for recreation, storytelling, and intergenerational bonding <br />
•	Transparent communication with families, ensuring trust and shared decision-making <br />
•	A team of professionals committed to excellence, empathy, and innovation
